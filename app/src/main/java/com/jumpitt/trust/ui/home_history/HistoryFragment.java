package com.jumpitt.trust.ui.home_history;
...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragment = inflater.inflate(R.layout.fragment_home_history, container, false);
        ButterKnife.bind(this, fragment);
        fragment.setTag(mPage);
        if (getActivity() instanceof HomeActivity) {
            homeListener = (HomeContract.View) getActivity();
        } else {
            Log.e(HistoryFragment.class.getSimpleName(), "Cannot instantiate listener");
        }
        return fragment;
    }
}
